               ...
               <form method="post" class="form-horizontal" enctype="multipart/form-data"><!-- form-horizontal Begin -->
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <br>
                          <img width="70" height="70" src="product_img/<?php echo  $p_image1; ?>" alt="<?php echo  $p_title; ?>">
                      </div><!-- col-md-6 Finish -->
...
if(isset($_POST['Update'])){
 ...
 //   $temp_name3 = $_FILES['product_img3']['tmp_name'];
  ...
  //  move_uploaded_file($temp_name3,"product_img/$product_img3");
    ...
    p_cat_id='$product_cat',  product_title=' $product_title' , product_img1='$product_img1',   
