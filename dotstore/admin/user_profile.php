               ...
               <form method="post" class="form-horizontal" enctype="multipart/form-data"><!-- form-horizontal Begin -->
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <img src="admin_img/<?php echo $admin_image; ?>" alt="<?php echo $admin_name; ?>" width="70" height="70">
...
if(isset($_POST['update'])){
    ...
    move_uploaded_file($temp_admin_image,"admin_img/$user_image");
    
    $update_user = "update admins set admin_name='$user_name',admin_email='$user_email',admin_pass='$user_pass',admin_country='$user_country',admin_contact='$user_contact',admin_job='$user_job',admin_about='$user_about',admin_img='$user_image' where admin_id='$user_id'";
