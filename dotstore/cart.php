                           ...
                           <table class="table"><!-- table Begin -->
                               ...
                               <?php 
                                   ...
                                   <tr><!-- tr Begin -->
                                       ...
                                       <td>
                                           ...
                                           <img class="img-responsive" src="admin/product_img/<?php echo "$product_img1"; ?>" alt="Product 3a">
                               ...
                               <tfoot><!-- tfoot Begin -->
                                   ...
                                   <tr><!-- tr Begin -->
                                       ...
                                       <th colspan="2">$<?php echo $total; ?> <td>
                    ...
                    <div class='col-md-3 col-sm-6 center-responsive'><!-- col-md-3 col-sm-6 center-responsive Begin -->
                       <div class='product same-height'><!-- product same-height Begin -->
                           <a href='details.php?pro_id=$pro_id'>
                               <img class='img-responsive' src='admin/product_img/$pro_img1' alt='Product 6'>
                            </a>
