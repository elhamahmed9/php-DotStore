  ...
  <div class="collapse navbar-collapse justify-content-end " id="navbarNavDropdown" style="margin-right: 130px;">
    <ul class="navbar-nav">
      ...
      <div class="container-fluid">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 " id="imgca">
    ...
    <div class="row justify-content-center align-items-start" style="padding-top:100px;">
        ...
        <p>
           Egypt, a country linking northeast Africa with the Middle East, dates to the time of the pharaohs. Millennia-old monuments sit along the fertile Nile River Valley, including Giza's colossal Pyramids and Great Sphinx as well as Luxor's hieroglyph-lined Karnak Temple and Valley of the Kings tombs. The capital, Cairo, is home to Ottoman landmarks like Muhammad Ali Mosque and the Egyptian Museum, a trove of antiquities.
             ...
             <span id="dots">.................. .</span>   <span id="more">Cairo is chaos at its most magnificent, infuriating and beautiful. From above, the distorted roar of the muezzins' call to prayer echoes out from duelling minarets. Below, car horns bellow tuneless symphonies amid avenues of faded 19th-century grandeur while donkey carts rattle down dusty lanes lined with colossal Fatimid and Mamluk monuments.
This mega-city's const
            </span>
            <br /> 
                ...
                <div class="modal-dialog">
                  ...
                  <div class="modal-content">
                    <div class="modal-header">
                      ...
                      <h4 class="modal-title">Cairo</h4>
                    </div>
                    <div class="modal-body">
                      <iframe style="max-width:100%;" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d55251.33564057918!2d31.22344493519765!3d30.059558098303356!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14583fa60b21beeb%3A0x79dfb296e8423bba!2sCairo%2C%20Cairo%20Governorate!5e0!3m2!1sen!2seg!4v1569321522944!5m2!1sen!2seg" width="600" height="450" frameborder="0"  allowfullscreen=""></iframe>
                    </div>
...
<div class="col-md-offset-1 col-md-11 align-self fle" id="animate2">
  ...
  <img class="medium img-responsive" src="img/cairo/cairo3.jpg" id="image2" style="display:inline-block"   value="img0"/>
  ...
  <section style="display:inline-block;">
            ...
            <img class="min1" src="img/cairo/cairo3.jpg"     id="id1"      value="img1"    onclick="changing(this);"/>
            <img class="min1" src="img/cairo/cairo.jpg"   id="id2"   	  value="img2"	onclick="changing(this);"/>
            <img class="min1" src="img/cairo/cairo1.jpg"   		id="id3"      value="img3"	onclick="changing(this);"/>
