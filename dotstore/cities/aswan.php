...
<body style="background-color: #f0efed !important;">
  ...
  <div class="collapse navbar-collapse justify-content-end " id="navbarNavDropdown" style="margin-right: 130px;">
    <ul class="navbar-nav">
      ...
      <div class="container-fluid">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 " id="imgas">
                ...
                <div class="modal-dialog">
                  ...
                  <div class="modal-content">
                    <div class="modal-header">
                      ...
                      <h4 class="modal-title">Aswan</h4>
                    </div>
                    <div class="modal-body">
                      <iframe   style="max-width:100%;" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d29138.074928028807!2d32.88259654861627!3d24.092372780336298!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14367b5ab1a30e5f%3A0xfb109fe337cabccb!2sAswan%2C%20Aswan%20Governorate!5e0!3m2!1sen!2seg!4v1570189012118!5m2!1sen!2seg" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
                    </div>
...
<div class="col-md-offset-1 col-md-11 align-self fle " id="animate2">
  ...
  <img class="medium img-responsive" src="img/aswan/img5.jpg" id="image2" style="display:inline-block"   value="img0"/>
  ...
  <section style="display:inline-block;">
            ...
            <img class="min1" src="img/aswan/img2.jpg"     id="id1"      value="img1"    onclick="changing(this);"/>
            <img class="min1" src="img/aswan/img5.jpg"   id="id2"   	  value="img2"	onclick="changing(this);"/>
            <img class="min1" src="img/aswan/img4.jpg"   		id="id3"      value="img3"	onclick="changing(this);"/>
